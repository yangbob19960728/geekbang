    ...
    receiveChar (char) {
        switch (this.current) {
            case this.WITING_STATUS_LINE:
                ...
                break;
            case this.WITING_STATUS_LINE_END:
                if (char === "\n") {
                    this.current = this.WITING_HEADER_NAME
                }
                break;
            case this.WITING_HEADER_NAME:
                if (char === ":") {
                ...
                break;
            case this.WITING_HEADER_SPACE:
                if (char === " ") {
                    this.current = this.WITING_HEADER_VALUE;
                }

                break;
            case this.WITING_HEADER_VALUE:
                if (char === "\r") {
                ...
                break;
            case this.WITING_HEADER_LINE_END:
                if (char === "\n") {
                    this.current = this.WITING_HEADER_NAME;
                }
                break;
            case this.WITING_HEADER_BLOCK_END:
                if (char === "\n") {
                    this.current = this.WITING_BODY;
                }
                break;
            case this.WITING_BODY:
                console.log(char);
